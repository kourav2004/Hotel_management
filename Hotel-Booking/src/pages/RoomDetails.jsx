...
const RoomDetails = () => {
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/* room hightlight */}
      <div className='flex flex-col md:flex-row md:flex-row md:justify-between mt-10'>
      ...
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl' >
        ...
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
          ...
          <div className='flex flex-col'> 
            <label htmlFor="checkInDate" className='font-medium'>Chech-In</label>
          ...
          <div className='flex flex-col'> 
            <label htmlFor="checkOutDate" className='font-medium'>Chech-Out</label>
      ...
      <div className='mt-25 space-y-4'>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
          <p>Guest will be allocated on the ground floor according to availability.You get a comfortable two bedroom apartment has atrue city feeling. The price quoted is for two guest,at the slot please mark the number of guest to get the exact price for groups, The Guests will be allocated ground floor according to availabilty. You get the comfortable two bedroom apartment that has a true city feeling</p>
        </div>
        {/* hosted by */}
